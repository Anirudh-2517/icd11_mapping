export default function Footer() {
  ...
  const socialIcons = [
    ...
    { 
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-2.012 0-3.64-1.628-3.64-3.64s1.628-3.64 3.64-3.64 3.64 1.628 3.64 3.64-1.628 3.64-3.64 3.64zm7.072 0c-2.012 0-3.64-1.628-3.64-3.64s1.628-3.64 3.64-3.64 3.64 1.628 3.64 3.64-1.628 3.64-3.64 3.64z"/>
        </svg>
      ),
